...
const SignInScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      <StatusBar backgroundColor="#0a0b1d" barStyle="dark-content" />
        ...
        <View>
          <View style={styles.button}>
            <TouchableOpacity
              style={styles.signIn}
              onPress={() => {
                loginHandel(data.username, data.password);
              }}>
              <LinearGradient
                colors={['#00f279', '#00fff7']}
                style={styles.signIn}>
                <Text style={[styles.textSign, {color: '#000'}]}>Sign In</Text>
              </LinearGradient>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              style={[
                styles.signIn,
                {borderColor: '#fff', borderWidth: 1, marginTop: 7},
              ]}>
